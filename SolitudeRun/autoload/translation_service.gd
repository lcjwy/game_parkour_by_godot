...
const MESSAGES: Dictionary = {
	...
	"en": {
		...
		"map.jungle": "Rainforest",
		"map.jungle.desc": "Wet leaves, dense green, rain curtains, and distant thunder.",
		"audio.wind": "Desert Wind",
		"audio.rain": "Rainforest Rain",
	...
	"ko": {
		...
		"map.jungle": "우림",
		"map.jungle.desc": "젖은 잎, 짙은 숲, 빗줄기와 먼 천둥.",
		"audio.wind": "사막 바람",
		"audio.rain": "우림 빗소리",
		"audio.engine": "낮은 엔진음",
		"hud.played": "플레이 시간",
