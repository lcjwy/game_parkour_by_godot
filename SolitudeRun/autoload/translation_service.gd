...
const MESSAGES: Dictionary = {
	"zh": {
		...
		"settings.control_hint_position": "按键提示位置",
		"settings.position.top_center": "顶部居中",
		"settings.position.top_left": "顶部左侧",
		"settings.position.top_right": "顶部右侧",
		"settings.back": "返回",
		"map.desert": "沙漠",
		...
		"audio.engine": "低沉引擎",
		"hud.played": "已游玩",
		"hud.controls": "W 前进 / Shift+W 加速前进",
	...
	"en": {
		...
		"settings.control_hint_position": "Control Hint",
		"settings.position.top_center": "Top Center",
		"settings.position.top_left": "Top Left",
		"settings.position.top_right": "Top Right",
		"settings.back": "Back",
		"map.desert": "Desert",
		...
		"hud.played": "Played",
		"hud.controls": "W Forward / Shift+W Boost",
	...
	"ko": {
		...
		"settings.control_hint_position": "조작 안내 위치",
		"settings.position.top_center": "상단 중앙",
		"settings.position.top_left": "상단 왼쪽",
		"settings.position.top_right": "상단 오른쪽",
		"settings.back": "뒤로",
		"map.desert": "사막",
